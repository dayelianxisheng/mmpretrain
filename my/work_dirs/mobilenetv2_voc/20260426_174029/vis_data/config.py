...
default_hooks = dict(
    ...
    early_stopping=dict(
        monitor='multi-label/mAP', patience=10, type='EarlyStoppingHook'),
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        betas=(
            0.9,
            0.999,
        ), lr=0.0003, type='Adam', weight_decay=0.0001))
param_scheduler = [
    dict(begin=0, by_epoch=True, end=5, type='LinearLR'),
    dict(T_max=95, begin=5, end=100, type='CosineAnnealingLR'),
]
...
work_dir = './work_dirs/mobilenetv2_voc'
